    ...
    function check_ccbill_response() {
      ...
      switch(strToLower($responseAction)){
        case 'checkoutsuccess': //print('Checkout Success');
                                wp_die('<p>Thank you for your order.  Your payment has been approved.</p><p><a href="' . get_permalink( get_option('woocommerce_myaccount_page_id') ) . '" title="' . _e('My Account','woothemes') . '">My Account</a></p><p><a href="?">Return Home</a></p>', 'Checkout Success', array( 'response' => 200 ) );
          break;
        case 'checkoutfailure': //wp_die('Checkout Failure');
                                wp_die('<p>Unfortunately, your payment was declined.</p><p><a href="' . $cart_url = $woocommerce->cart->get_cart_url() . '">Return to Cart</a></p>', 'Checkout Failure', array( 'response' => 200 ) );
          break;
